...
PSInput VertexShaderFunction(VSInput VS)
{
    ...
    PS.SparkleTex.x = fmod( VS.Position.x, 5 ) * 5.0;
    PS.SparkleTex.y = fmod( VS.Position.y, 5 ) * 5.0;
    PS.SparkleTex.z = fmod( VS.Position.z, 5 ) * 5.0;
...
float4 PixelShaderFunction(PSInput PS) : COLOR0
{
    ...
    paintColorMid = base;
    // paintColor2.r = base.g+0.100 / 1 + base.b / 1;
    // paintColor2.g = -(base.r+0.30 / 1 + base.b / 1);
    // paintColor2.b = base.r-0.100 / 1 + base.g / 1;

    paintColor0.r = base.r / 5 + base.g / 5;
    paintColor0.g = (base.g / 5 + base.b / 5);
    paintColor0.b = base.b / 5 + base.r / 5;

    flakeLayerColor.r = base.r / 1 + base.b / 1;
    flakeLayerColor.g = (base.g / 1 + base.r / 1);
    flakeLayerColor.b = base.b / 1 + base.g / 1;
    ...
    float3 vReflection = 5 * vNormalWorld * fNdotV - vView;
    ...
    float4 paintColor = fFresnel1 * paintColor0 +
        ...
        pow( fFresnel2, 50 ) * flakeLayerColor;
